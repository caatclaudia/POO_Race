...
class Carro
{
	string marca, modelo;			//static const???
	char ID;						//static const???
	double capacidadeMaxima;		//static const???
	double energia;
	int velocidade;
	int velocidadeMaxima;			//static const???
	bool movimento;
	bool emergencia;
	bool condutor;
	int acidente;
...
public:
	...
	Carro(string marca, double cInicial, double cMaxima, int vMaxima, string modelo="modelo base");
